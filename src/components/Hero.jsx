...
import { baseImgURL } from '../pages/redux/constant';
        ...
        <>
          ...
          <div className="col-md-6 d-flex flex-column gap-3 align-items-center justify-content-center">
            ...
            <div className="d-flex gap-3">
              <button className="btn btn-outline-danger">Filmi İzle</button>
              <button className="btn btn-outline-light">Listeye Ekle</button>
            </div>
          </div>
          
          <div className="col-md-6">
            <img
              className="img-fluid rounded shadow my-4 mt-0"
